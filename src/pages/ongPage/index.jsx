...
import { CardsContainer, Title, CardsHeader, LoaderContainer, TextNotFound } from "./style";
...
const OngPage = () => {
    ...
    const listOngsFilter = ongs.ongsList && ongs.ongsList
        .filter((ong) => {
        ...
        <>
            ...
            />
            {
               listOngsFilter && listOngsFilter.length > 0 ?
                    ...
                    :
                    <TextNotFound>Infelizmente não encontramos nenhuma ONG cadastrada com esse perfil :( </TextNotFound>
            }
        </>
    )
}
